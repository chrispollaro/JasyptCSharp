...
public class JasyptCompatibleEncryptionTest
{
    public static void Main(string[] args)
    {
        ...
        string encrypted = JasyptCSharp.JasyptCompatibleEncryption.Encrypt(plaintext, password);
        Console.WriteLine("Encrypted: " + encrypted);

      
        string decrypted = JasyptCSharp.JasyptCompatibleEncryption.Decrypt(encrypted, password);
        ...
        string decryptedTest = JasyptCSharp.JasyptCompatibleEncryption.Decrypt(test, password);
